    ...
    <div class="container-fluid">
        ...
        <div class="card rounded-2 overflow-hidden">
            ...
            <div class="card-body p-4">
                <span class="badge text-bg-light fs-2 rounded-4 py-1 px-2 lh-sm  mt-3">{{ $ptkform->division->division_name }}</span>
                ...
                <div class="position-relative">
                    <div class="p-4 rounded-2 bg-light mb-3">
                        <div class="d-flex align-items-center gap-3">
                            <img src="{{asset('package/dist/images/profile/user-2.jpg')}}" alt="" class="rounded-circle"
                                width="33" height="33">
                    ...
                    <div class="p-4 rounded-2 bg-light mb-3">
                        <div class="d-flex align-items-center gap-3">
                            <img src="{{asset('package/dist/images/profile/user-3.jpg')}}" alt="" class="rounded-circle"
                                width="33" height="33">
                    ...
                    <div class="p-4 rounded-2 bg-light">
                        <div class="d-flex align-items-center gap-3">
                            <img src="{{asset('package/dist/images/profile/user-4.jpg')}}" alt="" class="rounded-circle"
                                width="33" height="33">
